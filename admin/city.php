...
<head>
  ...
  <title><?php include '../dist/includes/title.php';?> | City/Municipality</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">City/Municipality</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card card-outline card-success">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  $query=mysqli_query($con,"select * from city order by city_name")or die(mysqli_error());
                    $i=0;
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <form method="post" action="functions.php">
                              ...
                              <div class="modal-body">
                                <p>Are you sure you want to delete <?php echo $city;?>?</p>
                                <input type="hidden" class="form-control" id="inputEmail3" placeholder="Category" name="id" value="<?php echo $id;?>">
                              </div>
                              <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-success" name="delete_city">Delete</button>
                              </div>
                            </form>
                          </div>
                          <!-- /.modal-content -->
            ...
            <div class="card card-danger shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter City/Municipality" name="city" required>
                </div>
              </div>
              <!-- /.card-body-->
              <div class="card-footer bg-transparent">
                <div class="row">
                  <div class="col-12 text-center">
                    <button type="submit" class="btn btn-success btn-block" name="add_city"><i class="fa fa-save"></i> Save</button>
                  </div>
                </div>
                <!-- /.row -->
              </div>
